...
CHARS = {
    ...
    "wilai":    lady(skin=THAI, hair="long", hc=BLACK, shirt=C(0xd0284a), bg=BG_GOGO, mouth="grin", mouthc=LIP),
    "kesinee":  lady(skin=THAI2, hair="chignon", hc=GRBLK, shirt=C(0x1e1a2a), bg=BG_GOGO, mouth="neutral", acc=["earrings", "chain"], earc=GOLD),
    ...
    "mala":     lady(skin=THAI, hair="chignon", hc=C(0x6a1a4a), shirt=C(0x1a8a7a), bg=BG_GOGO,
                     mouth="grin", acc=["earrings", "flower", "chain"], earc=GOLD),
    "petch":    lady(skin=THAI, hair="sleek", hc=BLACK, shirt=C(0x30d0e0), bg=BG_GOGO,
                     mouth="grin", acc=["earrings", "chain"], earc=CYAN),
    "nott":     dict(skin=THAI, hair="short", hc=BLACK, shirt=C(0x6a1a4a), collar=True,
                     mouth="smile", bg=BG_GOGO),
    "arm":      dict(skin=THAI2, hair="short", hc=BLACK, shirt=C(0x1a6a8a),
                     mouth="grin", bg=BG_GOGO),
    "win":      dict(skin=THAI, hair="short", hc=C(0x2a1a10), shirt=C(0x30c0b0),
                     mouth="smile", bg=BG_GOGO),
    ...
    # --- the Beach Road / Soi 8 bars (sea side calm, soi side loud) ---
    "sea_wall_fon": lady(skin=THAI, hair="long", hc=BLACK, shirt=C(0x2a5a6a), bg=BG_BAR, mouth="smile", acc=["earrings"], earc=SILVER),
    "sea_wall_kwang": lady(skin=THAI, hair="ponytail", hc=DKBRN, shirt=C(0x3a6a5a), bg=BG_BAR, mouth="grin", acc=["earrings"], earc=GOLD),
    "sea_wall_duang": lady(skin=THAI, hair="bob", hc=GRBLK, shirt=C(0x2a4a7a), bg=BG_BAR, mouth="neutral", acc=["earrings"], earc=SILVER),
    "sea_wall_gig": lady(skin=THAI, hair="chignon", hc=BLACK, shirt=C(0x4a5a6a), bg=BG_BAR, mouth="smile", acc=["earrings"], earc=GOLD),
    "breakwater_mook": lady(skin=THAI, hair="long", hc=DKBRN, shirt=C(0x2a5a6a), bg=BG_BAR, mouth="grin", acc=["earrings"], earc=SILVER),
    "breakwater_jib": lady(skin=THAI, hair="ponytail", hc=GRBLK, shirt=C(0x3a6a5a), bg=BG_BAR, mouth="neutral", acc=["earrings"], earc=GOLD),
    "breakwater_mookda": lady(skin=THAI, hair="bob", hc=BLACK, shirt=C(0x2a4a7a), bg=BG_BAR, mouth="smile", acc=["earrings"], earc=SILVER),
    "breakwater_kade": lady(skin=THAI, hair="chignon", hc=DKBRN, shirt=C(0x4a5a6a), bg=BG_BAR, mouth="grin", acc=["earrings"], earc=GOLD),
    "neon_palm_bee": lady(skin=THAI, hair="long", hc=GRBLK, shirt=C(0xe0407a), bg=BG_BAR, mouth="neutral", acc=["earrings"], earc=SILVER),
    "neon_palm_toey": lady(skin=THAI, hair="ponytail", hc=BLACK, shirt=C(0xf06020), bg=BG_BAR, mouth="smile", acc=["earrings"], earc=GOLD),
    "neon_palm_nittaya": lady(skin=THAI, hair="bob", hc=DKBRN, shirt=C(0xc030a0), bg=BG_BAR, mouth="grin", acc=["earrings"], earc=SILVER),
    "neon_palm_noey": lady(skin=THAI, hair="chignon", hc=GRBLK, shirt=C(0x20b0c0), bg=BG_BAR, mouth="neutral", acc=["earrings"], earc=GOLD),
    "the_bucket_pang": lady(skin=THAI, hair="long", hc=BLACK, shirt=C(0xe0407a), bg=BG_BAR, mouth="smile", acc=["earrings"], earc=SILVER),
    "mint": lady(skin=THAI, hair="ponytail", hc=DKBRN, shirt=C(0xf06020), bg=BG_BAR, mouth="grin", acc=["earrings"], earc=GOLD),
    "the_bucket_ratchada": lady(skin=THAI, hair="bob", hc=GRBLK, shirt=C(0xc030a0), bg=BG_BAR, mouth="neutral", acc=["earrings"], earc=SILVER),
    "the_bucket_fai": lady(skin=THAI, hair="chignon", hc=BLACK, shirt=C(0x20b0c0), bg=BG_BAR, mouth="smile", acc=["earrings"], earc=GOLD),
    "doghouse_bow": lady(skin=THAI, hair="long", hc=DKBRN, shirt=C(0x4a1a2a), bg=BG_BAR, mouth="smile", acc=["earrings"], earc=GOLD),
    # --- the four open-air beer bars on lower Pratumnak Soi 5 ---
    "the_terrace_fah": lady(skin=THAI, hair="long", hc=BLACK, shirt=C(0xe0603a), bg=BG_BAR, mouth="smile", acc=["earrings"], earc=SILVER),
    "the_terrace_namtip": lady(skin=THAI, hair="ponytail", hc=DKBRN, shirt=C(0x2a7a6a), bg=BG_BAR, mouth="grin", acc=["earrings"], earc=GOLD),
    "the_terrace_wandee": lady(skin=THAI, hair="bob", hc=GRBLK, shirt=C(0xd04a7a), bg=BG_BAR, mouth="neutral", acc=["earrings"], earc=SILVER),
    "the_terrace_kade": lady(skin=THAI, hair="chignon", hc=BLACK, shirt=C(0x3a5aa0), bg=BG_BAR, mouth="smile", acc=["earrings"], earc=GOLD),
    "kingfisher_praew": lady(skin=THAI, hair="long", hc=DKBRN, shirt=C(0x7a3a8a), bg=BG_BAR, mouth="grin", acc=["earrings"], earc=SILVER),
    "kingfisher_kaew": lady(skin=THAI, hair="ponytail", hc=GRBLK, shirt=C(0xc09a2a), bg=BG_BAR, mouth="neutral", acc=["earrings"], earc=GOLD),
    "kingfisher_somsri": lady(skin=THAI, hair="bob", hc=BLACK, shirt=C(0x2a8a4a), bg=BG_BAR, mouth="smile", acc=["earrings"], earc=SILVER),
    "kingfisher_noey": lady(skin=THAI, hair="chignon", hc=DKBRN, shirt=C(0xa03a3a), bg=BG_BAR, mouth="grin", acc=["earrings"], earc=GOLD),
    "two_stools_meaw": lady(skin=THAI, hair="long", hc=GRBLK, shirt=C(0xe0603a), bg=BG_BAR, mouth="neutral", acc=["earrings"], earc=SILVER),
    "two_stools_jinda": lady(skin=THAI, hair="ponytail", hc=BLACK, shirt=C(0x2a7a6a), bg=BG_BAR, mouth="smile", acc=["earrings"], earc=GOLD),
    "two_stools_ratree": lady(skin=THAI, hair="bob", hc=DKBRN, shirt=C(0xd04a7a), bg=BG_BAR, mouth="grin", acc=["earrings"], earc=SILVER),
    "two_stools_orm": lady(skin=THAI, hair="chignon", hc=GRBLK, shirt=C(0x3a5aa0), bg=BG_BAR, mouth="neutral", acc=["earrings"], earc=GOLD),
    "the_gecko_duan": lady(skin=THAI, hair="long", hc=BLACK, shirt=C(0x7a3a8a), bg=BG_BAR, mouth="smile", acc=["earrings"], earc=SILVER),
    "the_gecko_yok": lady(skin=THAI, hair="ponytail", hc=DKBRN, shirt=C(0xc09a2a), bg=BG_BAR, mouth="grin", acc=["earrings"], earc=GOLD),
    "the_gecko_somjai": lady(skin=THAI, hair="bob", hc=GRBLK, shirt=C(0x2a8a4a), bg=BG_BAR, mouth="neutral", acc=["earrings"], earc=SILVER),
    "the_gecko_ple": lady(skin=THAI, hair="chignon", hc=BLACK, shirt=C(0xa03a3a), bg=BG_BAR, mouth="smile", acc=["earrings"], earc=GOLD),
    ...
    "praewa":   lady(skin=THAI, hair="long", hc=BLACK, shirt=C(0xff1493), bg=BG_BAR, mouth="grin", acc=["earrings", "chain"], earc=CYAN),
    "nangfah":  lady(skin=THAI, hair="sleek", hc=BLACK, shirt=C(0xe86a9a), bg=BG_BAR, mouth="smile", acc=["earrings", "flower"], earc=YELN),
    "tabtim":   lady(skin=THAI, hair="ponytail", hc=DKBRN, shirt=C(0xd02040), bg=BG_BAR, mouth="grin", acc=["earrings", "bracelets"], earc=GOLD),
    "chaba":    lady(skin=THAI2, hair="pigtails", hc=BLACK, shirt=C(0xc0284a), bg=BG_BAR, mouth="grin", acc=["earrings", "flower"], earc=PINKN),
    "kluay":    lady(skin=THAI, hair="bob", hc=DKBRN, shirt=C(0xf0b020), bg=BG_BAR, mouth="smile", acc=["earrings", "chain"], earc=CYAN),
    "benz":     lady(skin=THAI, hair="sleek", hc=BLACK, shirt=C(0xd0104a), bg=BG_BAR, mouth="grin", acc=["earrings"], earc=GOLD),
    "pukky":    lady(skin=THAI, hair="bob", hc=DKBRN, shirt=C(0xf0a020), bg=BG_BEACH, mouth="smile", acc=["earrings", "chain"], earc=CYAN),
    "somo":     lady(skin=THAI2, hair="ponytail", hc=BLACK, shirt=C(0xd02040), bg=BG_BEACH, mouth="grin", acc=["earrings"], earc=YELN),
    "nina":     lady(skin=THAI, hair="long", hc=DKBRN, shirt=C(0x30a0d0), bg=BG_BEACH, mouth="smile", acc=["earrings", "flower"], earc=PINKN),
    "namfon":   lady(skin=THAI, hair="bob", hc=BLACK, shirt=C(0x2e6d9e), bg=BG_BAR, mouth="smile", acc=["earrings", "chain"], earc=CYAN),
    "bunny":    lady(skin=THAI, hair="ponytail", hc=DKBRN, shirt=C(0xe86a9a), bg=BG_BAR, mouth="grin", acc=["earrings", "flower"], earc=YELN),
    "jaja":     lady(skin=THAI2, hair="long", hc=BLACK, shirt=C(0x30a06a), bg=BG_BAR, mouth="smile", acc=["earrings"], earc=GOLD),
    "aump":     lady(skin=THAI, hair="bob", hc=DKBRN, shirt=C(0x8a3ad0), bg=BG_BAR, mouth="grin", acc=["earrings", "chain"], earc=PINKN),
    "guitar":   lady(skin=THAI, hair="ponytail", hc=BLACK, shirt=C(0xd05820), bg=BG_BAR, mouth="smile", acc=["earrings"], earc=CYAN),
    "namtip":   lady(skin=THAI, hair="long", hc=BLACK, shirt=C(0x2e7d6e), bg=BG_BAR, mouth="smile", acc=["earrings", "flower"], earc=YELN),
    "bella":    lady(skin=THAI2, hair="sleek", hc=DKBRN, shirt=C(0xcf30a0), bg=BG_BAR, mouth="grin", acc=["earrings", "bracelets"], earc=GOLD),
    "prik":     lady(skin=THAI, hair="pigtails", hc=BLACK, shirt=C(0xd02040), bg=BG_BAR, mouth="grin", acc=["earrings"], earc=CYAN),
    "mek":      lady(skin=THAI, hair="chignon", hc=GRBLK, shirt=C(0x303048), bg=BG_BAR, mouth="neutral", acc=["earrings", "chain"], earc=PINKN),
    ...
    "toi":      lady(skin=THAI, hair="bob", hc=GREY, shirt=C(0x2a1e3a), bg=BG_BAR, mouth="neutral", acc=["earrings", "chain"], earc=PINKN),
    "saeng":    lady(skin=THAI2, hair="chignon", hc=GRBLK, shirt=C(0x3a1020), bg=BG_BAR, mouth="stern", acc=["earrings", "chain"], earc=GOLD),
    "bussaba":  lady(skin=THAI, hair="bun", hc=SILVER, shirt=C(0x24303a), bg=BG_BAR, mouth="neutral", acc=["earrings", "glasses"], earc=CYAN),
    "sopha":    lady(skin=THAI2, hair="bob", hc=GREY, shirt=C(0x2e3a2e), bg=BG_BAR, mouth="neutral", acc=["earrings", "chain"], earc=YELN),
    "malila":   lady(skin=THAI, hair="bun", hc=GREY, shirt=C(0x2a2438), bg=BG_BAR, mouth="neutral", acc=["earrings", "glasses"], earc=PINKN, framec=GOLD),
    ...
    "baimon":   lady(skin=THAI, hair="ponytail", hc=BLACK, shirt=C(0x2a1e3a), collar=True, bg=BG_BAR, mouth="neutral", acc=["earrings", "lanyard"], earc=CYAN),
    "fahsai":   lady(skin=THAI, hair="sleek", hc=DKBRN, shirt=C(0x3a1020), collar=True, bg=BG_BAR, mouth="neutral", acc=["earrings", "ringchain"], earc=GOLD),
    "preaw":    lady(skin=THAI2, hair="bob", hc=BLACK, shirt=C(0x181820), collar=True, bg=BG_BAR, mouth="neutral", acc=["earrings", "glasses"], earc=PINKN, framec=SILVER),
    "numfon":   lady(skin=THAI, hair="ponytail", hc=GRBLK, shirt=C(0x24303a), collar=True, bg=BG_BAR, mouth="neutral", acc=["earrings", "ringchain"], earc=CYAN),
    "nu":       lady(skin=THAI2, hair="sleek", hc=BLACK, shirt=C(0x2e3a2e), collar=True, bg=BG_BAR, mouth="neutral", acc=["earrings", "lanyard"], earc=YELN),
    "haad":     lady(skin=THAI, hair="bob", hc=DKBRN, shirt=C(0x303040), collar=True, bg=BG_BAR, mouth="neutral", acc=["earrings", "glasses"], earc=GOLD, framec=SILVER),
