...
const _CATALOGS = {
  de: {
    ...
    "The name is the last classy thing about it. Duncan Ashcroft wanted a members' club — leather, low light, single malt, discretion — and got a bacchanal, because the room curdled to match its owner. The 'hostesses' start the night topless and end it well past that; the low light is a strobe; the discretion is a joke told at volume. The clientele is the soi's real economy: high rollers who tip in colours the pavement trade never sees, and at the corner tables the men the monthly envelope actually pays — a patched MC president holding court over a bottle of Blue Label, and, at the best table in the room, a soft-spoken Thai man in an unremarkable shirt whom everyone, the MC president included, is very careful to defer to. On a raised banquette at the back, filming himself over all of it, is Duncan Ashcroft — down when he is in the country, which is not often, and never anywhere the soi itself can see him.":
      "Der Name ist das letzte Stück Klasse daran. Duncan Ashcroft wollte einen Members' Club — Leder, gedämpftes Licht, Single Malt, Diskretion — und bekam ein Bacchanal, weil der Raum verdarb, bis er zu seinem Besitzer passte. Die 'Hostessen' beginnen den Abend oben ohne und enden ihn deutlich darüber hinaus; das gedämpfte Licht ist ein Stroboskop; die Diskretion ist ein laut erzählter Witz. Die Klientel ist die wahre Ökonomie der Soi: Highroller, die in Farben Trinkgeld geben, die das Straßengeschäft nie zu sehen bekommt, und an den Ecktischen die Männer, die der monatliche Umschlag wirklich bezahlt — ein MC-Präsident mit Kutte, der bei einer Flasche Blue Label Hof hält, und, am besten Tisch im Raum, ein leise sprechender Thai in einem unscheinbaren Hemd, dem alle, den MC-Präsidenten eingeschlossen, sehr sorgfältig den Vortritt lassen. Auf einer erhöhten Bank hinten, sich selbst über allem filmend, sitzt Duncan Ashcroft — wenn er im Land ist, was selten vorkommt, und nie dort, wo die Soi selbst ihn sehen kann.",
    ...
    "Back into the Orchid Room and the strobe and the noise and the skin, the members' club Ashcroft keeps calling classy while it proves him wrong in every direction at once.":
      "Zurück in den Orchid Room, das Stroboskop, der Lärm, die nackte Haut — der Mitgliederclub, den Ashcroft ständig \"classy\" nennt, während er ihm in jeder Hinsicht gleichzeitig widerspricht.",
    "The Orchid takes you back into its expensive bacchanal — the high rollers, the MC patches, the quiet Thai man at the good table, and, on the nights he is in the country at all, Ashcroft on his banquette narrating himself to his own {{phone}}.":
      "Der Orchid holt dich zurück in seine teure Bacchanalie — die High Roller, die MC-Patches, der stille Thai-Mann am guten Tisch, und, an den Abenden, an denen er überhaupt im Land ist, Ashcroft auf seiner Bank, der sich selbst seinem eigenen Handy vorführt.",
