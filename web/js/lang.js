...
const _CATALOGS = {
  de: {
    ...
    "The beaches, the food": "Die Strände, das Essen",
    "Honestly? The beaches, the food… the culture.": "Ehrlich gesagt? Die Strände, das Essen … die Kultur.",
    "\"The beaches.\" He nods, and means it. \"Good ones, too. Jomtien for the quiet end, Naklua if you want a boat and nobody selling you anything.\" A glance in the mirror with no joke in it at all. \"People come here for all sorts, my friend. The ones who say beaches mostly get beaches.\" The indicator ticks. \"And if the week turns out different from the plan — mai pen rai. The town is good at that too. Tell me what you want to see and I will tell you where it is.\"":
      "\"Die Strände.\" Er nickt, und er meint es. \"Gute noch dazu. Jomtien für das ruhige Ende, Naklua, wenn du ein Boot willst und niemanden, der dir etwas verkauft.\" Ein Blick in den Spiegel, ganz ohne Scherz darin. \"Die Leute kommen aus allen möglichen Gründen hierher, mein Freund. Die, die Strände sagen, bekommen meistens Strände.\" Der Blinker tickt. \"Und wenn die Woche anders läuft als geplant — mai pen rai. Darin ist die Stadt auch gut. Sag mir, was du sehen willst, und ich sage dir, wo es ist.\"",
    ...
    "Soft sand, folded-up loungers, and the last smear of sunset dying over the sea. Two grey-and-white soi cats hold down the end of a lounger, the big one sitting slightly in front of the small one, both watching the water. The beach road glows to the east; the sand runs north up the shore and narrows south toward the Soi 7 end, where a drinks cart is parked.":
    ...
    "Pattaya Leisure's flagship, and the loudest argument for why the group should not be allowed nice things. The front is open to the street; half the bar is technically the pavement. Neon tubes frame the sign in three colours simultaneously. Inside, the pink is structural — walls, barstools, the girls' outfits, arguably the air itself. Joy is already talking before you sit down. A staircase at the back climbs to the short-time rooms; beside it, a velvet-roped, unmarked door leads to the ORCHID ROOM — the group's members-only back room, and very much not for tonight's walk-up trade. (GO BACK, if you think you're on the list.)":
      "Pattaya Leisures Flaggschiff, und das lauteste Argument dafür, warum man der Gruppe keine schönen Dinge anvertrauen sollte. Die Front ist offen zur Straße; die halbe Bar ist streng genommen Gehsteig. Neonröhren rahmen das Schild in drei Farben gleichzeitig. Drinnen ist das Pink strukturell — Wände, Barhocker, die Outfits der Mädchen, wohl auch die Luft selbst. Joy redet schon, bevor du dich setzt. Eine Treppe hinten führt hinauf zu den Kurzzeit-Zimmern; daneben führt eine samtbeseilte, unbeschriftete Tür zum ORCHID ROOM — dem Members-only-Hinterzimmer der Gruppe, und ganz sicher nichts für die Laufkundschaft von heute Abend. (GO BACK, falls du glaubst, du stehst auf der Liste.)",

    "The name is the last classy thing about it. Laurent Vasseur wanted a members' club — leather, low light, single malt, discretion — and got a bacchanal, because the room curdled to match its owner. The 'hostesses' start the night topless and end it well past that; the low light is a strobe; the discretion is a joke told at volume. The clientele is the soi's real economy: high rollers who tip in colours the pavement trade never sees, and at the corner tables the men the monthly envelope actually pays — a patched MC president holding court over a bottle of Blue Label, and, at the best table in the room, a soft-spoken Thai man in an unremarkable shirt whom everyone, the MC president included, is very careful to defer to. On a raised banquette at the back, above all of it and touching none of it, is Laurent Vasseur — down when he is in the country, which is not often, and never anywhere the soi itself can see him.":
      "Der Name ist das letzte Stück Klasse daran. Laurent Vasseur wollte einen Members' Club — Leder, gedämpftes Licht, Single Malt, Diskretion — und bekam ein Bacchanal, weil der Raum verdarb, bis er zu seinem Besitzer passte. Die 'Hostessen' beginnen den Abend oben ohne und enden ihn deutlich darüber hinaus; das gedämpfte Licht ist ein Stroboskop; die Diskretion ist ein laut erzählter Witz. Die Klientel ist die wahre Ökonomie der Soi: Highroller, die in Farben Trinkgeld geben, die das Straßengeschäft nie zu sehen bekommt, und an den Ecktischen die Männer, die der monatliche Umschlag wirklich bezahlt — ein MC-Präsident mit Kutte, der bei einer Flasche Blue Label Hof hält, und, am besten Tisch im Raum, ein leise sprechender Thai in einem unscheinbaren Hemd, dem alle, den MC-Präsidenten eingeschlossen, sehr sorgfältig den Vortritt lassen. Auf einer erhöhten Bank hinten, über allem und nichts davon berührend, sitzt Laurent Vasseur — wenn er im Land ist, was selten vorkommt, und nie dort, wo die Soi selbst ihn sehen kann.",

    "Open-fronted, louder than you expected from outside, which is saying something. The gold dragon above the bar was hand-painted by someone's cousin and has been there longer than most of the staff. Vintage Thai pop on the speakers — not the jukebox: that died in 2019, so the music comes off somebody's {{phone}} through the QR sticker the new owners put on every table. Almost nobody scans it, so the playlist stays whatever the last man who bothered chose, which is how it has stayed vintage. Pia keeps the bar — and the dead jukebox's memory — with a flat, unbothered calm.":
      "Nach vorn offen, lauter als von außen erwartet, was etwas heißen will. Der goldene Drache über der Bar wurde von irgendjemandes Cousin von Hand gemalt und hängt dort länger als die meisten Angestellten. Alter Thai-Pop aus den Boxen — nicht die Jukebox: die starb 2019, die Musik kommt also von irgendjemandes Handy über den QR-Aufkleber, den die neuen Besitzer auf jeden Tisch geklebt haben. Fast niemand scannt ihn, also bleibt die Playlist das, was der Letzte ausgesucht hat, der sich die Mühe gemacht hat; so ist sie alt geblieben. Pia führt die Bar — und das Andenken der toten Jukebox — mit flacher, unbeeindruckter Ruhe.",
    ...
    "Open to the pavement, walled in cat posters and a neon paw print, with a curtained doorway at the back into the cold half — pool table, toilets, and the only aircon on this stretch of the soi, which is where everybody drifts by midnight. Praewa and Nangfah work the front, and the grab-and-giggle starts before you've fully stopped walking; Kesinee watches it all from the end of the rail, pricing you before you sit, and Baimon has the till. A staircase at the back goes up to the short-time rooms, and a corridor past the till goes (BACK) to an office nobody is invited into.":
      "Zur Straße offen, zugepflastert mit Katzenpostern und einem Neon-Pfotenabdruck. Praewa und Nangfah bearbeiten die Front, und das Grapschen-und-Kichern beginnt, bevor du ganz zum Stehen gekommen bist; Kesinee beobachtet alles vom Ende des Tresens und preist dich ein, bevor du dich setzt, und Baimon hat die Kasse. Eine Treppe hinten führt hinauf zu den Kurzzeit-Zimmern, und ein Gang hinter der Kasse führt (BACK) zu einem Büro, in das niemand eingeladen ist.",
    ...
    "\"Nong? The trembling one over at the Gold Rush.\" Something almost maternal crosses her face. \"I worked that bar before this one — first week she was, scared of the door, scared of Mamasan, scared of everything. I was her, twelve years ago, a go-go on Soi 6.\" A softer smile. \"Somebody should tell her the worst thing that happen is you go all the way to Munich and come back. Not so bad, in the end. I still keep an eye out, from here.\"":
      "\"Nong? Die Zittrige drüben im Gold Rush.\" Etwas fast Mütterliches geht über ihr Gesicht. \"Ich hab die Bar vor dieser gearbeit — erste Woche war sie, Angst vor Tür, Angst vor Mamasan, Angst vor allem. Ich war sie, vor zwölf Jahr, Go-go auf Soi 6.\" Ein weicheres Lächeln. \"Jemand soll ihr sag: schlimmste, was passier, ist du geh ganz bis München und komm zurück. Nicht so schlimm, am Ende. Ich pass immer noch auf, von hier.\"",
    "\"Nong, over at the Gold Rush — I was her, twelve years ago. I keep an eye out.\"":
      "\"Nong, drüben im Gold Rush — ich war sie, vor zwölf Jahr. Ich pass auf.\"",
    ...
    "Back into the Orchid Room and the strobe and the noise and the skin, the members' club Vasseur keeps calling classy while it proves him wrong in every direction at once.":
      "Zurück in den Orchid Room, das Stroboskop, der Lärm, die nackte Haut — der Mitgliederclub, den Vasseur ständig \"classy\" nennt, während er ihm in jeder Hinsicht gleichzeitig widerspricht.",
    "The Orchid takes you back into its expensive bacchanal — the high rollers, the MC patches, the quiet Thai man at the good table, and, on the nights he is in the country at all, Vasseur on his banquette watching his own room the way a man watches a share price.":
      "Der Orchid holt dich zurück in seine teure Bacchanalie — die High Roller, die MC-Patches, der stille Thai-Mann am guten Tisch, und, an den Abenden, an denen er überhaupt im Land ist, Vasseur auf seiner Bank, der seinen eigenen Laden beobachtet wie ein Mann einen Aktienkurs.",
    "Back past the velvet rope into the wild dark. Nobody here is walk-up trade; everybody here is somebody's problem, and the banquette at the back is either empty or has a bottle on it nobody is drinking.":
      "Zurück am Samtseil vorbei in das wilde Dunkel. Hier ist niemand Laufkundschaft; jeder hier ist irgendjemandes Problem, und die Bank hinten ist entweder leer, oder es steht eine Flasche darauf, aus der niemand trinkt.",
    ...
    "two soi cats":
      "zwei Soi-Katzen",
    "Two grey-and-white shorthairs holding down the end of a lounger like a deposit. Sisters, plainly — same coat, same sea-watching squint — though the little one is a runt who never grew into her ears, and the big one sits slightly in front of her the way she always has and always will. The beach calls them Big One and Little One; Auntie Nok feeds them scraps and calls them her security. They have watched a thousand of these sunsets and fully intend to watch a thousand more. (PET them, if Big One permits it.)":
    ...
    "The sky over the gulf goes grey, then pink, and even Pattaya blinks. The last bars stack their stools; the baht buses carry home the wreckage; somewhere a rooster who fears nothing starts up. You drift back and let the day take you.":
      "Der Himmel über dem Golf wird grau, dann rosa, und selbst Pattaya blinzelt. Die letzten Bars stapeln ihre Hocker; die Baht-Busse tragen die Trümmer der Nacht heim; irgendwo legt ein Hahn los, der nichts und niemanden fürchtet. Du lässt dich zurücksinken und überlässt dich dem Tag.",
    ...
    "The Pattaya Leisure Offer": "Das Angebot von Pattaya Leisure",
    "Pattaya Leisure want to buy Bert's bar out from under its dying owner. Get him the real picture — the history (ASK TERRY ABOUT PATTAYA LEISURE), the inside view (ASK KESINEE ABOUT PATTAYA LEISURE, at the Kitten Corner), and the pitch (ASK GAVIN ABOUT THE OFFER), at the Golden Dragon on Soi 6 — then tell Bert (ASK BERT ABOUT THE OFFER). Kesinee talks straight to men she has seen spend: a drink for one of her girls first.":
      "Pattaya Leisure will Berts Bar dem sterbenden Besitzer unter dem Hintern wegkaufen. Verschaff ihm das ganze Bild — die Vorgeschichte (ASK TERRY ABOUT PATTAYA LEISURE), die Sicht von innen (ASK KESINEE at the Kitten Corner ABOUT PATTAYA LEISURE) und das Angebot selbst (ASK GAVIN at the Golden Dragon, Soi 6, ABOUT THE OFFER) — und dann sag es Bert (ASK BERT ABOUT THE OFFER). Kesinee redet Klartext mit Männern, die sie hat Geld ausgeben sehen: erst ein Drink für eines ihrer Mädchen.",

    "Gavin's Errand": "Gavins Botengang",
    "Gavin would like a quiet favour: have a word with Bert about selling the Stinky to Pattaya Leisure. \"Friend to friend. Soften him up. Everyone wins, and Pattaya Leisure looks after its friends.\" (Take it to Bert — ASK BERT ABOUT SELLING — or don't. No one's forcing you.)":
      "Gavin hätte gern einen stillen Gefallen: Red mal mit Bert darüber, das Stinky an Pattaya Leisure zu verkaufen. „Von Freund zu Freund. Mach ihn weich. Alle gewinnen, und Pattaya Leisure kümmert sich um seine Freunde.“ (Sprich mit Bert darüber — ASK BERT ABOUT SELLING — oder lass es. Dich zwingt niemand.)",
    ...
    "The near end of Soi 7, off the south end of the beach road: a mellow strip of open-front beer bars strung with fairy lights — LUCKY 7 BAR and SEA BREEZE BAR — with SUNSET OIL MASSAGE keeping a quieter door between them, and the easy Jomtien pace — older expats, cold beer, nobody in a hurry. The soi runs east, deeper inland toward Second Road; the sea breeze follows you a little way in. The sand itself is west, past the beach road.":
      "Das nahe Ende der Soi 7, am Südende der Strandstraße: eine gemächliche Reihe offener Bierbars mit Lichterketten — LUCKY 7 BAR und SEA BREEZE BAR — mit der SUNSET OIL MASSAGE, die dazwischen eine ruhigere Tür offenhält, und das entspannte Jomtien-Tempo — ältere Expats, kaltes Bier, niemand in Eile. Die Soi führt nach Osten, tiefer landeinwärts Richtung Second Road; die Meeresbrise begleitet dich noch ein Stück hinein. Der Strand selbst liegt westlich, hinter der Strandstraße.",
    ...
    "Where Soi 7 finally gives out onto the sand: a scrap of hard-packed beach, a couple of upturned boats, and Auntie Nok's drinks cart parked in the lee of a sea almond tree, cooler humming. The beach opens north; Soi 7 runs back inland to the east, up toward the middle of the soi.":
      "Wo die Soi 7 endlich auf den Sand ausläuft: ein Flecken festgetretener Strand, ein paar umgedrehte Boote und Tante Noks Getränkewagen im Windschatten eines Seemandelbaums, die Kühlbox brummt. Der Strand öffnet sich nach Norden; die Soi 7 läuft nach Osten landeinwärts zurück, hinauf zur Mitte der Soi.",
