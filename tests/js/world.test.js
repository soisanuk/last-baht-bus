...
test("gossip chain flags connect: every required flag is set somewhere", () => {
  const settable = new Set(["knowWasHere", "waiedOy", "waiedPloy", "greetedFon",
    ...
    "scoutSent",       // engine-set by _doGive (the revue flyer → diamond) — Mala hears the answer she sent for (Arturo, round 47)
    ...
    "ccibSecondCoffee", "ccibLanded", "ccibLoudAfter",  // laying low has teeth (_ccibCoffee / _ccibLand)
